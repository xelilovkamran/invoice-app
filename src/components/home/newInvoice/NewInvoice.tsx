...
function NewInvoice({ reference }: Props) {
    ...
    const [formData, setFormData] = useState<TInvoice>({
    ...
    const onInput = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (targetData.includes(".")) {
            ...
            setFormData({
                ...formData,
                [targets[0]]: {
                    ...(formData[targets[0] as keyof TInvoice] as TAddress),
                ...
                <form className="max-w-lg">
                    ...
                    <div className="mb-5">
                        ...
                        <div>
                            ...
                            <div>
                                {formData.items.map(
                                    (_item: TPaymentItem, index: number) => (
                                        <div key={index}>
                                            <PaymentItem
                                                data={formData}
                                                setData={setFormData}
