...
function SideBar() {
    ...
    return (
        <div
            className={`select-none tablet:w-24 tablet:h-screen w-full max-tablet:pr-8  ${
                theme === "light" ? "bg-[#373B53]" : "bg-[#1E2139]"
            }  tablet:rounded-r-3xl flex justify-between tablet:flex-col flex-row z-[3]`}
        >
            <Link to={"/"}>
            ...
            <div className="flex tablet:flex-col flex-row justify-center items-center gap-8">
                ...
                <div className="tablet:py-8 tablet:w-full max-tablet:h-full max-tablet:pl-8  tablet:border-t-[1px] border-l-[1px] border-[#494E6E] flex justify-center items-center">
                    <img
                        src={avatarURL ? avatarURL : profilePicture}
                        alt="avatar"
